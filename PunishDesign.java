...
public class PunishDesign implements ActionListener{
...
//	DefaultTableModel studentTableModel = null;
	...
	public JComponent createpanel() {
		...
		jlenable = new JLabel("是否生效");
		jldescription = new JLabel("描述        ");
		jltotal = new JLabel("处罚记录情况表");
		...
		//为表格添加监听器 
				...
				{ 
					...
					{ 
						...
						jtflevels.setText((String) v.get(2));// 代码
						jtftime.setText((String) v.get(3));// 记录时间
						jtfenable.setText((String) v.get(4));
		...
		jtfenable.setPreferredSize(new Dimension(0, 28));
	...
	public void queryProcess(String sQueryField)
	{
		try{
			// 建立查询条件
			String sql = "select * from punishment where ";
...
//			}
	...
	public void insertProcess()
	{
		...
		// 建立插入条件
		String sql = "insert into punishment(id ,studentid ,levels, enable ,description) values('";
		sql = sql + id + "','";
		sql = sql + studentid + "','";
		sql = sql + levels + "','";
//		sql = sql + time + "','";
...
//			System.out.println("e = " + e);
	...
	public void updateProcess()
	{
		...
		insertProcess();
//		// 建立更新条件
//		String sql = "update punishment set id = '";
//		sql = sql + id + "', levels = '";
...
//		}
	...
	public void deleteCurrentRecordProcess()
	{
		...
		// 建立删除条件
		String sql = "delete from punishment where studentid = '" + studentid + "';";
