...
public class ChangeDesign implements ActionListener{
...
//		JTextArea jtfdescription=new JTextArea(3, 3);             //描述的多行文本输入框  有待完善
//		JScrollPane pane=new JScrollPane(jtfdescription);
...
//		pane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
		...
		//为表格添加监听器 
				...
				{ 
					...
					{ 
						...
						jtfchang_code.setText((String) v.get(2));// 变更代码
		...
		jtfchang_code.setPreferredSize(new Dimension(0, 28));
		jtftime.setPreferredSize(new Dimension(0, 28));
		jtfdescription.setPreferredSize(new Dimension(0, 28));
		
//		p5.add(pane);
//		jtfdescription.setPreferredSize(new Dimension(50, 50));
//		jtfdescription.setLineWrap(true);   描述文本换行
...
//					&& !jtfdescription.getText().isEmpty()
	...
	public void queryProcess(String sQueryField)
	{
		try{
			// 建立查询条件
			String sql = "select * from changedata where ";
...
//			}
			...
			while(rs.next()){
				...
				v.add(rs.getString("change_code"));
	...
	public void queryAllProcess()
	{
		try{
			// 建立查询条件
			String sql = "select * from changedata;";
	...
	public void insertProcess()
	{
		...
		String change_code = jtfchang_code.getText().trim();
		String time = jtftime.getText().trim();
		String description = jtfdescription.getText().trim();
		
		// 建立插入条件
		String sql = "insert into changedata(id ,studentid , change_code , description) values('";
		sql = sql + id + "','";
		sql = sql + studentid + "','";
		sql = sql + change_code + "','";
//		sql = sql + time + "','";
...
//			System.out.println("e = " + e);
	...
	public void updateProcess()
	{
		...
		insertProcess();
		// 建立更新条件
//		String sql = "update changedata set id = '";
//		sql = sql + id + "', change_code = '";
//		sql = sql + change_code + "', rec_time = '";
...
//		}
	...
	public void deleteCurrentRecordProcess()
	{
		...
		// 建立删除条件
		String sql = "delete from changedata where studentid = '" + studentid + "';";
	...
	{
		// 建立删除所有条件
		String sql = "delete from changedata;";
